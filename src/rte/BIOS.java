...
public class BIOS {
  ...
  private static final int BIOS_MEMORY = 0x60000;
  private static final int BIOS_STKEND = BIOS_MEMORY + 0x1000;
  private static final int BIOS_STKBSE = BIOS_STKEND - 0x28;
  ...
  public static final BIOSRegs regs = (BIOSRegs) MAGIC.cast2Struct(BIOS_STKBSE);

  public static final short F_CARRY = 0x0001;
  public static final short F_PARITY = 0x0004;
  public static final short F_AUX = 0x0010;
  public static final short F_ZERO = 0x0040;
  public static final short F_SIGN = 0x0080;
  public static final short F_TRAP = 0x0100;
  public static final short F_INT = 0x0200;
  public static final short F_DIR = 0x0400;
  public static final short F_OVER = 0x0800;
  ...
  public static void rint(int inter) {
    ...
    InterruptHandler.loadInterruptDescriptorTableRealMode();
